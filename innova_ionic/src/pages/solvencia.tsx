...
import { IonContent, IonHeader, IonPage, IonTitle, IonToolbar, IonButton, IonList, IonItem, IonText } from '@ionic/react';
...
const Solvencia: React.FC = () => {
  const history = useHistory(); // Usa useHistory para la navegación
    ...
    <IonPage>
      ...
      <IonContent className="ion-padding" style={{ backgroundColor: 'white' }}>
        ...
        <IonButton
          ...
          onClick={() => history.push('/solvency')} // Usa history.push para navegar
        >
          Ver Solvencia
        </IonButton>
      </IonContent>
