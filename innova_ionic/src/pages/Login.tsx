        ...
        <>
            <div className='w-[100%] h-[100vh] flex flex-col place-items-center space-y-2 bg-violet-700'>
                ...
                <form className='w-[100%] grid grid-cols-1 place-items-center my-6 gap-5'>
                    ...
                    <input onChange={onChange} name="contrasena" type="password" placeholder='Password' className='w-[80%] h-[50px] bg-white rounded-2xl !text-black placeholder-gray-700 px-4' />
